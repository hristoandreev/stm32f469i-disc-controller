...
public:
    ...
    void setEnterAction(GenericCallback<> *callback_p);
    void setCancelAction(GenericCallback<> *callback_p);
...
private:
    ...
    /**
     * Callback for the keyboard settings button.
     */
    Callback<CustomKeyboard> settingsPressed;
    ...
    /**
     * Callback for the keyboard cancel button.
     */
    ...
    /**
     * Callback handler for the settings button.
     */
    void settingsPressedHandler();
